...
var CollectionControls = React.createClass({
    ...
    toggleEditColectionName: function(){
        this.setState({
    ...
    render: function(){
        if (this.state.isEditingName) {
            return (
                <CollectionRenameForm name={this.state.name} onChangeCollectionName ={this.setCollectionName} onCancelCollectionNameChange={this.toggleEditColectionName}/>
            );
        }
        return(
            <div>
                <Header text={this.getHeaderText()}/>
                <Button label="Raname collection" handleClick={this.toggleEditColectionName}/>
