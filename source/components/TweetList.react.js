...
var TweetList = React.createClass({
    ...
    getTweetElement: function(tweetId){
        ...
        var handleRemoveTweetFromeCollection = this.props.onRemoveTweetFromCollection;
        var tweetElement;
        if (handleRemoveTweetFromeCollection) {
            tweetElement=(
                <Tweet tweet={tweet} onImageClick={handleRemoveTweetFromeCollection}/>
            );
        }else{
